...
|---|---|---|---|---|---|
| LLM returns invalid JSON | Medium | High | Enforce schema validation + retry + fallback error UX | Team | Open |
| Unsafe training recommendations | Medium | High | Add hard guardrails and explicit constraints in prompt + post-checks | Team | Open |
